...
def prepare_multi_gpu_env(args: argparse.Namespace) -> Dict[str, str]:
    ...
    if args.use_fsdp:
        ...
        current_env["FSDP_RESHARD_AFTER_FORWARD"] = str(args.fsdp_reshard_after_forward).lower() # TODO(s1ro1): this breaks with old configs, maybe too harsh?
        current_env["FSDP_OFFLOAD_PARAMS"] = str(args.fsdp_offload_params)
