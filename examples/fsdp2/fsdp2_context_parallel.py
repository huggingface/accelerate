...
def parse_args():
    ...
    parser.add_argument("--sequence-length", type=int, default=65536, help="Sequence length for the dataset")
    ...
    parser.add_argument(
        "--context-parallel-shard-rotation", type=str, default="alltoall", help="Context parallel shard rotation"
    )
...
def main():
    ...
    accelerator.print(f"Starting training with context parallel for {args.num_steps} steps...")
    ...
    for step, batch in enumerate(dataloader):
        ...
        # Perform training step with context parallel
