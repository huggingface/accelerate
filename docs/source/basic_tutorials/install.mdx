...
As 🤗 Accelerate is rapidly under development, new features are added every day that haven't been released yet. To try them out yourself install
...
After installing, you need to tell Accelerate how the current system is setup for training. 
