...
<Tip>
    This will be stored inside of a function as you will set your seed during training.
</Tip>
...
First you should create an [`Accelerator`] object as early in the training loop as possible, and set the seed.

<Tip warning={true}>
    If training on the TPU, your training loop should take in the model as a parameter and it should be instantiated 
    outside of the training loop function. See the [TPU best practices](https://huggingface.co/docs/accelerate/concept_guides/training_tpu) 
    to learn why
</Tip>
...
Next you should instantiate the rest of the PyTorch classes:
...
Before finally the last major difference. When performing distributed evaluation, the predictions and labels need to be passed through 
...
You pass in the function, the arguments (as a tuple), and the number of processes to train on. (See the [documentation](https://huggingface.co/docs/accelerate/launcher) for more information)
