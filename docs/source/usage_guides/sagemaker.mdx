...
### Use Amazon FSx for Lustre and Amazon EFS

In order to use Amazon FSx for Lustre and Amazon EFS, you must specify the file system attributes in your input data file.

Example:
```
name	path
data	{"file_system_id": "fs-ysk123", "file_system_type": "FSxLustre", "directory_path": "/ysk123/dir1/", "file_system_access_mode": "rw"}
```
